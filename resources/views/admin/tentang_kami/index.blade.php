<x-app-layout>
    <div class="bg-white p-4 rounded shadow-sm">
        <h1 class="text-xl font-bold mb-8">Daftar Tentang Kami</h1>
        <a href="{{ route('tentang_kami.create') }}" class="text-sm bg-blue-600 text-white px-4 py-2 rounded">Tambahkan Tentang Kami</a>
