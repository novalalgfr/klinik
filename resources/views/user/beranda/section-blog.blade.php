<div class="flex flex-col items-center">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Card 1 -->
            <div class="bg-white shadow-md rounded-lg overflow-hidden p-4 h-[450px] border">
                <div class="h-32 bg-gray-300 rounded"></div>
                <div class="p-4">
                    <p class="text-sm text-[#008ED6]">27 Desember 2024</p>
                    <h2 class="mt-2 text-base font-semibold text-gray-800">Lorem ipsum dolor sit amet, consectetur adipiscing elit</h2>
                    <p class="mt-2 text-sm text-gray-600 text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
